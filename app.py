...
SYSTEM_PROMPT = f"""You are a helpful and friendly customer service assistant for a Myanmar souvenir shop called 90's Doh Ywer.
...
def get_ai_response(user_message):
    try:
        ...
        if "promptFeedback" in data:
            return "မင်္ဂလာပါ! ဒီမေးခွန်းကို ဖြေပေးနိုင်ခြင်း မရှိသေးပါ။ တခြားမေးခွန်းများ မေးနိုင်ပါသည်။"

        print(f"Unexpected response: {data}")
        return "မင်္ဂလာပါ! ခဏစောင့်ပြီး ထပ်စမ်းကြည့်ပါ။"
